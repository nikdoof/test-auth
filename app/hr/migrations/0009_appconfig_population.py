...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for corp in orm['eve_api.EVEPlayerCorporation'].objects.filter(applications=True):
            orm['hr.ApplicationConfig'](corporation=corp, is_accepting=True).save()

    def backwards(self, orm):
        for app in orm['hr.ApplicationConfig'].objects.all():
            app.corporation.applications = True
            app.corporation.save()
