...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationConfig.api_accessmask'
        db.add_column('hr_applicationconfig', 'api_accessmask', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicationConfig.api_accessmask'
        db.delete_column('hr_applicationconfig', 'api_accessmask')
    ...
    models = {
        ...
        'hr.applicationconfig': {
            ...
            'api_accessmask': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'hr.audit': {
            'Meta': {'ordering': "['date']", 'object_name': 'Audit'},
        ...
        'hr.templatemessage': {
            'Meta': {'ordering': "['config', 'name']", 'object_name': 'TemplateMessage'},
            'config': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'templates'", 'to': "orm['hr.ApplicationConfig']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
