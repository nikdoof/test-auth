...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hr_applicationconfig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('corporation', self.gf('django.db.models.fields.related.OneToOneField')(related_name='application_config', unique=True, to=orm['eve_api.EVEPlayerCorporation'])),
            ('is_accepting', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('api_required', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('api_view', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('hr', ['ApplicationConfig'])


    def backwards(self, orm):
        
        # Deleting model 'ApplicationConfig'
        db.delete_table('hr_applicationconfig')
