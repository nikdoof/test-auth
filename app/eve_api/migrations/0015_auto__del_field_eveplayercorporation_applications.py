...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EVEPlayerCorporation.applications'
        db.delete_column('eve_api_eveplayercorporation', 'applications')


    def backwards(self, orm):
        
        # Adding field 'EVEPlayerCorporation.applications'
        db.add_column('eve_api_eveplayercorporation', 'applications', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
