...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EVEPlayerCharacterSkill.in_training'
        db.add_column('eve_api_eveplayercharacterskill', 'in_training', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EVEPlayerCharacterSkill.in_training'
        db.delete_column('eve_api_eveplayercharacterskill', 'in_training')
