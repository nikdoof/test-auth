...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PermissionRule'
        db.create_table('sso_permissionrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ruleset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rules', to=orm['sso.PermissionRuleset'])),
            ...
            ('check_type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('sso', ['PermissionRule'])

        # Adding model 'PermissionRuleset'
        db.create_table('sso_permissionruleset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('check_type', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sso', ['PermissionRuleset'])


    def backwards(self, orm):
        
        # Deleting model 'PermissionRule'
        db.delete_table('sso_permissionrule')

        # Deleting model 'PermissionRuleset'
        db.delete_table('sso_permissionruleset')
