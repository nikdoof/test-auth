...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SSOUser.primary_character'
        db.add_column('sso_ssouser', 'primary_character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_api.EVEPlayerCharacter'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SSOUser.primary_character'
        db.delete_column('sso_ssouser', 'primary_character_id')
    ...
    models = {
        ...
        'sso.ssouseripaddress': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
