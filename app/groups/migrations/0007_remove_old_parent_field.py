...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('groups_groupinformation', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['auth.Group'], blank=True), keep_default=False)
