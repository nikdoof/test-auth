...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupInformation.moderated'
        if db.backend_name == "sqlite3":
            default = 1
        else:
            default = True
        db.add_column('groups_groupinformation', 'moderated', self.gf('django.db.models.fields.BooleanField')(default=default), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'GroupInformation.moderated'
        db.delete_column('groups_groupinformation', 'moderated')
