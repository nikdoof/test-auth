...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field parent_groups on 'GroupInformation'
        db.create_table('groups_groupinformation_parent_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groupinformation', models.ForeignKey(orm['groups.groupinformation'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('groups_groupinformation_parent_groups', ['groupinformation_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field parent_groups on 'GroupInformation'
        db.delete_table('groups_groupinformation_parent_groups')
    ...
    models = {
        ...
        'groups.groupinformation': {
            ...
            'parent_groups': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'+'", 'blank': 'True', 'to': "orm['auth.Group']"}),
