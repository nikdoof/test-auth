...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for obj in orm.GroupInformation.objects.all():
            if obj.parent is not None:
                obj.parent_groups.add(obj.parent)

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration, manually select parent groups for each groupinformation.")
