...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EVEPlayerCharacter.id'
        db.alter_column('eve_api_eveplayercharacter', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'EVEPlayerCorporation.id'
        db.alter_column('eve_api_eveplayercorporation', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'EVEPlayerCharacterRole.id'
        db.alter_column('eve_api_eveplayercharacterrole', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'EVEAccount.api_user_id'
        db.alter_column('eve_api_eveaccount', 'api_user_id', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'EVEAccount.id'
        db.alter_column('eve_api_eveaccount', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'EVEPlayerAlliance.id'
        db.alter_column('eve_api_eveplayeralliance', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'EVEPlayerCharacter.id'
        db.alter_column('eve_api_eveplayercharacter', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'EVEPlayerCorporation.id'
        db.alter_column('eve_api_eveplayercorporation', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'EVEPlayerCharacterRole.id'
        db.alter_column('eve_api_eveplayercharacterrole', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'EVEAccount.api_user_id'
        db.alter_column('eve_api_eveaccount', 'api_user_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'EVEAccount.id'
        db.alter_column('eve_api_eveaccount', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'EVEPlayerAlliance.id'
        db.alter_column('eve_api_eveplayeralliance', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
    ...
    models = {
        ...
        'eve_api.eveaccount': {
            ...
            'api_user_id': ('django.db.models.fields.BigIntegerField', [], {}),
